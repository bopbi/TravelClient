...
class FeaturedAdapter : ListAdapter<Tour, FeaturedAdapter.TourItemViewHolder>(TourDiffCallback()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, position: Int): TourItemViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_featured_tour, parent, false)
